...
class SWMM_ENV:
    ...
    def reset(self,raine,rainw,i,trainlog,testid):
        ...
        storage_states={}
        for _temp in self.config["states"]:
            if _temp[0] == 'CC-storage':
                storage_states['CC-storage']=nodes[_temp[0]].depth
            if _temp[0] == 'JK-storage':
                storage_states['JK-storage']=nodes[_temp[0]].depth
    ...
    def step(self,action):
        ...
        return storage_states,states,rewards,results,done
